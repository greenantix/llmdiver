...
exports.AuraChatProvider = void 0;
const vscode = __importStar(require("vscode"));
class AuraChatProvider {
    constructor(_extensionUri, connection) {
...
exports.AuraChatProvider = AuraChatProvider;
AuraChatProvider.viewType = 'aura.chat';
